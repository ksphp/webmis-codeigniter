...
INSERT INTO wmis_sys_menus (`id`, `fid`, `title`, `url`, `perm`, `ico`, `remark`, `ctime`, `sort`) VALUES (4, 1, '桌面', '#', '0', 'ic0-disktop', '系统桌面！', '2010-01-01 08:00:00', 0);
...
INSERT INTO wmis_sys_menus (`id`, `fid`, `title`, `url`, `perm`, `ico`, `remark`, `ctime`, `sort`) VALUES (7, 4, '用户首页', 'welcome', '1', 'ic0-user1', '系统用户首页！', '2010-01-01 08:00:00', 0);
...
INSERT INTO wmis_sys_menus (`id`, `fid`, `title`, `url`, `perm`, `ico`, `remark`, `ctime`, `sort`) VALUES (14, 1, '帐号管理', '#', '0', 'ic0-user', '帐号管理！', '2012-03-30 14:49:29', 0);
INSERT INTO wmis_sys_menus (`id`, `fid`, `title`, `url`, `perm`, `ico`, `remark`, `ctime`, `sort`) VALUES (15, 14, '修改密码', 'sys_change_passwd', '1', 'ic0-pwd', '修改密码！', '2012-03-30 14:37:30', 0);
...
INSERT INTO wmis_web_html (`id`, `class`, `title`, `img`, `uname`, `ctime`, `state`, `click`, `key`, `summary`, `content`) VALUES (1, ':7:5:', '关于我们', '', 'kingsoul', '2013-02-28 09:59:32', '1', 0, '关于我们,灵创网络,WebMIS', '关于我们', '<p>&nbsp; &nbsp; &nbsp;&nbsp; 灵创网络专业提供互联网行业相关服务，专精于web基础媒体上的创作团队，是一支极具创意技术和和商业能力的团队组合而成。从创建初就执着于建立高品质的 网站，发觉新的视觉语言，开创新的天地。公司的主要业务有，网站建设制作、网站推广、网站维护、淘宝店铺装修、画册设计、网站整体策划设计制作、企业邮 局、网站资料更新维护、网站营销，为您提供全方位服务。</p>\n<p><strong>WEB软件开发</strong></p>\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
我们自主开发了一套Web版的企业资源管理系统（WebMIS），WebMIS-快速、实用、免费开源的PHP开发底层系统。基于CI的MVC模式开发的多用户、多权限解决方案，整合了Jquery、TinyMCE编辑器等插件、简洁美观的弹框效果；</p>\n<p><strong>网站建设制作</strong></p>\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 多年网站建设经验总结，让我们变得更加专业、专注；</p>\n<p><strong>网站推广</strong></p>\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 引导更多客户流量，让您的网站更有价值；</p>\n<p><strong>网站维护</strong></p>\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 我们来为您更新网站信息，处理网站问题，大幅度降低维护费用；</p>\n<p><strong>&nbsp;Linux服务器架构和维护</strong></p>\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
提供专业、安全的架构方案，我们可以代理维护，从而降低维护费用；</p>\n<p><strong>&nbsp;平面设计、广告设计</strong></p>\n<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 根据客户要求、整合行业特色，提供优质的设计方案；</p>\n<p>&nbsp;</p>');
INSERT INTO wmis_web_html (`id`, `class`, `title`, `img`, `uname`, `ctime`, `state`, `click`, `key`, `summary`, `content`) VALUES (2, ':7:8:', '联系方式', '', 'kingsoul', '2013-02-28 10:01:00', '1', 0, '联系方式,灵创网络,WebMIS', '联系方式', '<div style=\"color: #666;\">\n<div style=\"font: 30px 黑体;\"><br /><strong>灵创网络</strong></div>\n<div style=\"font-size: 10px;\">LINGCHUANG NETWORK</div>\n</div>\n<p>地 址：云南.昆明 国家经济技术开发区牛街庄综合市场C幢5-5室<br />邮 编：650217<br />电 话：153681181712( 杨经理 )<br />网 址：www.ksphp.com<br />邮 箱：admin@ksphp.com<br />QQ群：<strong>206642028</strong></p>\n<p>&nbsp;饿死的发</p>');
...
INSERT INTO wmis_web_news_html (`id`, `nid`, `content`) VALUES (1, 1, '<p style=\"text-align: center;\">&nbsp;</p>\n<p style=\"text-align: center;\"><img src=\"/upload/images/20130621/80961368671891.jpg\" alt=\"微软开发者解释为什么Windows内核落后于Linux\" width=\"600\" height=\"277\" /></p>\n<p>&nbsp;</p>\n<p>&nbsp; &nbsp; &nbsp; &nbsp;微软Windows操作系统在复杂负荷情况下的性能落后于Linux，这已是公认的事实。Linux内核发布了一个又一个新版本，我们能看到它不断改进 I/O调度、进程调度、文件系统优化，TCP/IP堆栈的无线网络优化，等等等等。</p>\n<p>&nbsp; &nbsp; &nbsp; &nbsp;一位微软Windows NT内核开发者<a href=\"http://blog.zorinaq.com/?e=74\" target=\"_blank\">承认</a>，Windows内核与Linux内核之间的性能差距正日益拉大。他通过Tor(原因显而易见)在Hacker
News上<a href=\"https://news.ycombinator.com/item?id=5689391\" target=\"_blank\">匿名发帖</a>(已 经自行删除)，指出问题的根源不是技术方面而是社会性的。微软开发者几乎没人会为了自己为了荣耀而去改进内核，Linux世界的那些现象在微软这样的大企 业不会发生。能指挥开发者改进特定条件下系统性能的人的动机通常是出于商业意图，而在商业上性能的重要性从来没有被认为攸关生死，所以改进系统性能没有正 式或非正式的程序。</p>\n<p>&nbsp; &nbsp; &nbsp; &nbsp;微软在Windows &nbsp;SP3前开始关注安全是因为他们认为安全是商业目标的存在性威胁，而性能不是存在性威胁。内核不同组件的负责人对外部递交补丁一般都是充满敌意的，非提前
计划的改变可能会影响原定目标，领导会生气，测试组也会生气，产品经理也会发怒。内核开发团队因此没有动机去接受外界递交的补丁。你总能找到理由说不，但 很少有动机去说好的。而在Linux世界，如果能把某一功能的性能改进5%，你将会被万众瞩目。</p>\n<p>&nbsp;</p>');
INSERT INTO wmis_web_news_html (`id`, `nid`, `content`) VALUES (2, 2, '<p>&nbsp; &nbsp; &nbsp; &nbsp;似乎Windows 8就是一个不该出生的孩子。在地球上不受欢迎也就算了，远在太空的国际空间站(ISS)也没有打算接受这个&ldquo;野心颇大&rdquo;的系统。据外媒报道，ISS决定在接下来的系统升级中，弃用Windows，转而使用Linux。</p>\n<p style=\"text-align: center;\"><img src=\"/upload/images/20130621/36831368672071.jpg\" alt=\"国际空间站决定弃用 Windows 启用 Linux\" width=\"600\" height=\"406\" /></p>\n<p>&nbsp; &nbsp; &nbsp; &nbsp;ISS中的计算机系统由多台在同一网络运行下的笔记本组成。它可以保证宇航员日常重要事项的正常运行；告知宇航员他们所处的位置，管理运行中的设备，甚至还能连接到摄像机，拍摄太空照片与视频并通过互联网分享给地球上的人。</p
