...
<table class="table_add">
	<tr>
		...
		<td>
			<input type="text" id="file_perm" name="perm" class="input" style="width: 80%;" maxlength="4" datatype="n4-4" errormsg="4<?php echo $this->lang->line('inc_form_num');?>" sucmsg="<?php echo $this->lang->line('inc_form_pass');?>" nullmsg="<?php echo $this->lang->line('inc_form_null');?>" />
