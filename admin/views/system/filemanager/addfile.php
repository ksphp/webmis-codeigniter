...
<table class="table_add">
	<tr>
		...
		<td>
			<input type="text" name="file" class="input" value="test.txt" style="width: 80%;" maxlength="20" datatype="*2-20" errormsg="2~20<?php echo $this->lang->line('inc_form_char');?>" sucmsg="<?php echo $this->lang->line('inc_form_pass');?>" nullmsg="<?php echo $this->lang->line('inc_form_null');?>" />
