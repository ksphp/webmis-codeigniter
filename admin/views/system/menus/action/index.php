...
<table class="table_list">
	<tr class="title" id="menus_action_table">
		...
		<td width="60">ID</td>
		<td width="80"><?php echo $this->lang->line('sys_menu_a_title');?></td>
		<td width="80"><?php echo $this->lang->line('sys_menu_a_name');?></td>
		<td width="80"><?php echo $this->lang->line('sys_menu_a_perm');?></td>
