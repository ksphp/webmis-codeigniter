<script language="javascript" src="<?php echo base_url('../webmis/plugin/edit/tinymce/tinymce.min.js'); ?>"></script>
...
<table class="table_add">
	...
	<tr>
		...
		<td>
			<input type="text" id="datepicker" name="ctime" value="<?php echo $edit->ctime;?>" class="input" style="width: 130px;" />
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<input type="submit" id="newsSub" value="<?php echo $this->lang->line('inc_edit');?>" />
		</td>
	</tr>
	</tbody>
