...
<head>
	...
	<script language="javascript" src="<?php echo base_url('../webmis/plugin/jquery.form.js'); ?>"></script>
	<script language="javascript" src="<?php echo base_url('../webmis/plugin/ajaxfileupload.js'); ?>"></script>
	<script language="javascript" src="<?php echo base_url('../webmis/plugin/ueditor/editor_all.js'); ?>"></script>
	<script language="javascript" src="<?php echo base_url('../webmis/plugin/Validform_v5.3_min.js'); ?>"></script>
</head>
