...
<table class="table_add">
	...
	<tr>
		...
		<td>
			<input type="text" name="url" class="input" style="width: 180px;" datatype="*2-32" errormsg="至少2个字符,最多32个字符！" value="<?php echo $edit->url;?>" />
			<span class="Validform_checktip"></span>
		</td>
	</tr>
	<tr>
		...
		<td>
			<textarea name="remark" style="width: 320px; height: 120px;"><?php echo $edit->remark;?></textarea>
		</td>
	</tr>
	<tr>
