...
<script language="javascript" src="<?php echo base_url('../webmis/plugin/jquery/jquery-2.0.3.min.js'); ?>"></script>
<script language="javascript" src="<?php echo base_url('../webmis/jquery.webmis.js'); ?>"></script>
<script language="javascript" src="<?php echo base_url('js/admin_login.mo.js'); ?>"></script>
</body>
</html>