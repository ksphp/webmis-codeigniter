		...
		<div class="left ct_l">
			<div class="box">
				<div class="box_top">
					...
					<span class="class"><a href="<?php echo base_url($this->config->config['index_url'].'pro.html');?>" ><?php echo $navName;?></a>&nbsp;&nbsp;>&nbsp;&nbsp;详细信息</span>
				</div>
				<div class="show_ct">
					<div class="body">
						<div class="title"><h2><?php echo $show->title;?></h2></div>
						<div class="other">发布时间：<?php echo $show->ctime;?>&nbsp;&nbsp;浏览：<?php echo $show->click;?></div>
